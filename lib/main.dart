...
import 'features/dentalhome/screens/jadwal_kunjungan_screens.dart';
...
class KlinikGigiApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      initialRoute: authProvider.isLoggedIn ? '/main_screen' : '/jadwal_kunjungan_screen',
      ...
      routes: {
        ...
        '/jadwal_kunjungan_screen': (context) => const SchedulePage(),
