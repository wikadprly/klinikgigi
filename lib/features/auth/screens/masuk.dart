            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    // 🧩 Logo dengan padding kiri-kanan bisa diatur
                    Padding(
                      padding: const EdgeInsets.only(left: 85, right: 5),
                      child: Align(
                        alignment: Alignment.centerLeft, // agar logo tampak agak kiri
                        child: Image.asset(
                          'assets/images/logo_klinik_kecil.png',
                          height: 160, // perbesar biar proporsional
                        ),
                      ),
                    ),
                    ...
                    Text(
                      ...
                      style: AppTextStyles.heading.copyWith(
                        ...
                        fontSize: 32, // sedikit lebih besar dari sebelumnya
                      ),
                    ),
                  ],
                ),
